...
## Initial state (before configureApplication)
...
### Action — POST JavaMonitor /test/configureApplication

### Wire send — test → JavaMonitor (POST /test/configureApplication)

```
name=DemoApp&autoRecover=true
```
