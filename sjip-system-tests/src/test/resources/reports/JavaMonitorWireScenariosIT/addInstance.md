...
## Initial state (before addInstance)
...
### Action — POST JavaMonitor /test/addInstance

### Wire send — test → JavaMonitor (POST /test/addInstance)

```
id=1&hostName=localhost&applicationName=DemoApp&port=12345
```
