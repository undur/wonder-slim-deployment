# refuse_command_captures_wireShape
...
## Send REFUSE to the instance

### Action — POST monitorRequest{commandWotaskd: [REFUSE, {hostName, port}]} to wotaskd
...
<monitorRequest type="NSDictionary">
	<commandWotaskd type="NSArray">
		<element type="NSString">REFUSE</element>
		<element type="NSDictionary">
			<hostName type="NSString">1.2.3.4</hostName>
			<port type="NSNumber">12345</port>
		</element>
