# start_command_captures_wireShape
...
## Send START to the instance

### Action — POST monitorRequest{commandWotaskd: [START, {hostName, port}]} to wotaskd
...
<monitorRequest type="NSDictionary">
	<commandWotaskd type="NSArray">
		<element type="NSString">START</element>
		<element type="NSDictionary">
			<hostName type="NSString">1.2.3.4</hostName>
			<port type="NSNumber">12345</port>
		</element>
